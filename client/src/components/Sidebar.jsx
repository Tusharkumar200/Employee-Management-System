...
const Sidebar = () => {
    ...
    const sidebarContent = (
        <>
            ...
            <div className='p-3 border-t border-white/6'>
                ...
                .5 rounded-md text-[13px] font-medium text-slate-400 hover:text-rose-400 hover:bg-rose-500/8 transition-all duration-150'>
    ...
    return (
        <>
            ...
            {/* Sidebar - mobile */}
            <aside className={`lg:hidden fixed iinset-y-0 left-0 w-72 bg-linear-to-b from-slate-900 via-slate-900 to-slate-950 text-white z-50 flex flex-col transform transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}>
                {sidebarContent}
            </aside>
        </>
    )
