            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 sm:gap-5 mb-8'>
                {stats.map((s) => (
                    <div key={s.label} className='card card-hover p-5 sm:p-6 relative overflow-hidden group flex items-center justify-between' >
                        ...
                        <s.icon className='size-10 p-2.5 rounded--lg bg-slate-100 text-slate-600 group-hoverbg-indigo-50 group-hover:text-indigo-600 transition-colors duration-200' />
                    </div>
                ))}
            </div>
